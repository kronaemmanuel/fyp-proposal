...
\title  {\underline{\Large{Final Year Project Proposal}} \linebreak Computer Driven Vehicle with Route Optimization \linebreak}

\session {2018 -- 2022}
\advisor {Prof. Dr. Muhammad Shoaib}
\authors {  % please enter the students names and registration numbers
Student Name \quad 2018-CS-?? \\
Student Name \quad 2018-CS-?? \\
Student Name \quad 2018-CS-?? \\
Student Name \quad 2018-CS-?? \\
}
